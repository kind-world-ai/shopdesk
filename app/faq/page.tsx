...
export const metadata: Metadata = genMeta({
  title:
    "AgenticVani FAQ — All Questions Answered About Our Business Tools",
  description:
    "Answers to every question about AgenticVani — Salon CRM, Construction CRM, pricing, setup, support, refunds, and more. 20 frequently asked questions covered.",
  path: "/faq",
  keywords: [
    "agenticvani faq",
    "salon crm faq",
...
const aboutFaqs: FAQ[] = [
  ...
  {
    q: "Who is AgenticVani for?",
    a: "AgenticVani is designed for two specific types of Indian small businesses: (1) Beauty salons, parlours, and spas that need appointment tracking, staff commission calculation, inventory management, and GST billing. (2) Civil construction contractors who need RA Bill generation, BOQ tracking, material reconciliation, payment aging, and EVM dashboards. If you're a salon owner with 2–15 staff, or a contractor managing 1–10 projects, AgenticVani is built for you.",
  },
  {
    q: "How is AgenticVani different from Tally or other accounting software?",
    a: "Tally is accounting software — it handles ledgers, GST filing, and financial compliance. AgenticVani is an operations tool — it handles what happens before the accounting. For salons: appointments, commission tracking, daily cash reconciliation, client history. For contractors: RA Bills, BOQ quantities, material wastage, payment follow-ups. Most AgenticVani users also use Tally for their accounting. The two work together — AgenticVani generates the operational data that feeds into your Tally entries. See our detailed comparison at /vs/tally.",
  },
  {
    q: "Is AgenticVani a one-time purchase or subscription?",
...
const pricingFaqs: FAQ[] = [
  {
    q: "How do I get support after buying AgenticVani?",
  ...
  },
  {
    ...
    a: "AgenticVani offers a 7-day refund policy. If you buy the product and find it doesn't fit your business needs within 7 days of purchase, email hello@agenticvani.com with your order details and reason. Full refund, no questions asked. After 7 days, refunds are considered on a case-by-case basis. Note: since the product is a Google Sheet that you copy to your own Drive, we can't technically \"take it back\" — the refund policy is trust-based.",
  },
  {
    q: "Can I share AgenticVani with my business partner?",
    a: "Yes. Since AgenticVani lives in Google Sheets, you can share it with anyone using Google's built-in sharing. Share with your business partner as an Editor so they can enter data and view dashboards. Share with your CA as a Viewer so they can access financial summaries for tax filing. Share with your manager as an Editor for daily operations. There's no per-user licensing — once you buy it, share it with as many people as your business needs.",
  },
  {
    q: "Will AgenticVani work on my Android phone?",
...
const sections = [
  { title: "About AgenticVani", faqs: aboutFaqs },
      ...
      <section className="bg-cream px-4 pt-20 pb-16 md:px-8 md:pt-28 md:pb-24">
        <div className="mx-auto max-w-3xl">
          ...
          <p className="mb-12 text-lg text-mid-grey max-w-2xl">
            Everything you need to know about AgenticVani — our products, pricing,
          ...
          <div className="mt-16 rounded-2xl bg-navy p-8 text-center md:p-10">
            ...
            <p className="mb-6 text-cream/60">
              WhatsApp us or email hello@agenticvani.com — we reply within 2 hours
